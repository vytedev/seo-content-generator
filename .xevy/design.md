...
The Radix viewport exclusively owns vertical Select overflow; the outer portal content clips rather than creating a second scroll container. Short menus show no unnecessary scrollbar or scroll controls, long menus retain Radix keyboard and pointer scrolling, and opening or closing a Select must not shift the page layout.
