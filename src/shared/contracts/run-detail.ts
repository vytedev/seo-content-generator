...
import { RunActivitySchema } from "../commands.js";
...
export const RunDetailSchema = z
  .object({
    ...
    serp_probe: z
      ...
      .strict()
      .default({ status: "pending", evidence: null, warning: null, warnings: [] }),
    activity: z.array(RunActivitySchema).default([]),
